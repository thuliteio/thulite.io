...
description = "Hyas is now Thulite, a rename that better reflects the framework's direction while keeping its focus on fast, secure Hugo websites."
summary = "Hyas is now Thulite, a rename that better reflects the framework's direction while keeping its focus on fast, secure Hugo websites."
